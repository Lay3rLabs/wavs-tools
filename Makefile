...
build-abi:
	...
	@cp -r submodules/eigenlayer-middleware/out/ISlashingRegistryCoordinator.sol avs_sync/src/contracts/abi/
	@cp -r submodules/eigenlayer-middleware/out/OperatorStateRetriever.sol avs_sync/src/contracts/abi/
